...
{
    /**
     * Приватный массив forms
     * @var Model[]|array[]
     */
    private $forms = [];

    /**
     * Для того чтобы понимать какие формы есть внутри, а каких нету
     * добавили абстрактный протектед метод, в которм возвращаем какие формы должны быть вложены в его форму
     * @return array
     */
    ...
    /**
     * Магические методы get и set, чтобы по названиям того же meta,
     * например, извлекать и записывать вложенные формы внутри
     * @param string $name
